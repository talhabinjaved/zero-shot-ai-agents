...
'''
    ...
    def start_openhands_conversation(self, repo_full_name: str, idea: ExperimentIdea) -> str:
        ...
        if idea.has_experiments:
            ...
            Your tasks:
            1. Review the AGENTS.md and .openhands/microagents/repo.md files for guidance
            2. Validate the provided experiment plan in experiments/experiments.yaml
            3. Implement all missing code or scripts needed for the experiment steps
            4. Monitor CI workflow execution and fix any failing sanity checks
            5. Execute the provided experiments faithfully
            6. Generate a comprehensive README.md with results when experiments complete
            7. Document findings, limitations, and next steps
            ...
            Your tasks:
            1. Review the AGENTS.md and .openhands/microagents/repo.md files for guidance
            2. Analyze the idea and design a comprehensive experiment plan
            3. Create experiments/experiments.yaml with ordered steps, dependencies, and sanity checks
            4. Include baseline/control experiments for comparison
            5. Implement all code and scripts needed for the experiment steps
            6. Monitor CI workflow execution and fix any failing sanity checks
            7. Generate a comprehensive README.md with results when experiments complete
            8. Document findings, limitations, and next steps

            Start by designing a rigorous experiment plan from the ground up based on the idea.
            """
